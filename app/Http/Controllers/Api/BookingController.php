...
class BookingController extends Controller
{
    ...
    public function storeByProperty(
        ...
        // The main BookingController doesn't have a constructor, it uses dependency injection in store()
        // So we instantiate it and call store directly with the required dependencies
        $bookingController = new \App\Http\Controllers\BookingController();
        return $bookingController->store($request, $createBookingAction);
    }
}
